 ...
 * @main index.js
 * @author A user
 * @description Playground of components
 */
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".ComponentPlayground-Category-category {\n    margin-bottom: 20px;\n}\n\n.ComponentPlayground-Category-category-header {\n    display: flex;\n    flex-direction: row;\n    cursor: pointer;\n    margin-bottom: 20px;\n}\n\n.ComponentPlayground-Category-category-header-details{\n    flex: 1;\n}\n\n.ComponentPlayground-Category-category-header-title {\n    font-size: 1.5em;\n    font-weight: bold;\n}\n\n.ComponentPlayground-Category-category-header-icon-wrapper{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 48px;\n    height: 48px;\n}\n\n.ComponentPlayground-Category-category-header-icon{\n    width: 24px;\n    height: 24px;\n    color: var(--interactive-active);\n}\n\n.ComponentPlayground-Category-category-header-icon.ComponentPlayground-Category-opened{\n    transform: rotate(-90deg);\n}\n\n.ComponentPlayground-Category-category-content {\n    margin-left: 14px;\n    padding-left: 20px;\n}", "",{"version":3,"sources":["webpack://./node_modules/.pnpm/ittai@1.0.4/node_modules/ittai/components/Category.css"],"names":[],"mappings":"AAAA;IACI,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,eAAe;IACf,mBAAmB;AACvB;;AAEA;IACI,OAAO;AACX;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,gCAAgC;AACpC;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB","sourcesContent":[".category {\n    margin-bottom: 20px;\n}\n\n.category-header {\n    display: flex;\n    flex-direction: row;\n    cursor: pointer;\n    margin-bottom: 20px;\n}\n\n.category-header-details{\n    flex: 1;\n}\n\n.category-header-title {\n    font-size: 1.5em;\n    font-weight: bold;\n}\n\n.category-header-icon-wrapper{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 48px;\n    height: 48px;\n}\n\n.category-header-icon{\n    width: 24px;\n    height: 24px;\n    color: var(--interactive-active);\n}\n\n.category-header-icon.opened{\n    transform: rotate(-90deg);\n}\n\n.category-content {\n    margin-left: 14px;\n    padding-left: 20px;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"category": "ComponentPlayground-Category-category",
	"category-header": "ComponentPlayground-Category-category-header",
	"category-header-details": "ComponentPlayground-Category-category-header-details",
	"category-header-title": "ComponentPlayground-Category-category-header-title",
	"category-header-icon-wrapper": "ComponentPlayground-Category-category-header-icon-wrapper",
	"category-header-icon": "ComponentPlayground-Category-category-header-icon",
	"opened": "ComponentPlayground-Category-opened",
	"category-content": "ComponentPlayground-Category-category-content"
};
...
var ___CSS_LOADER_EXPORT___ = _builder_node_modules_pnpm_css_loader_5_2_7_webpack_5_67_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_builder_node_modules_pnpm_css_loader_5_2_7_webpack_5_67_0_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".ComponentPlayground-HeaderOptions-pill{background:var(--background-secondary-alt);padding:4px 8px;border-radius:4px;margin-right:8px}.ComponentPlayground-HeaderOptions-wrapper{background:var(--background-tertiary);padding:4px 8px;border-radius:4px;margin-bottom:20px}", "",{"version":3,"sources":["webpack://./components/HeaderOptions.scss"],"names":[],"mappings":"AAAA,wCACI,0CAAA,CACA,eAAA,CACA,iBAAA,CACA,gBAAA,CAGJ,2CACI,qCAAA,CACA,eAAA,CACA,iBAAA,CACA,kBAAA","sourcesContent":[".pill {\n    background: var(--background-secondary-alt);\n    padding: 4px 8px;\n    border-radius: 4px;\n    margin-right: 8px;\n}\n\n.wrapper {\n    background: var(--background-tertiary);\n    padding: 4px 8px;\n    border-radius: 4px;\n    margin-bottom: 20px;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"pill": "ComponentPlayground-HeaderOptions-pill",
	"wrapper": "ComponentPlayground-HeaderOptions-wrapper"
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
// NAMESPACE OBJECT: ./node_modules/.pnpm/ittai@1.0.4/node_modules/ittai/packages/react.js
...
const manifest_namespaceObject = JSON.parse('{"u2":"ComponentPlayground"}');
...
var options = {"attributes":{"ittai":true,"plugin":"ComponentPlayground"}};
...
var ToastWrapper_options = {"attributes":{"ittai":true,"plugin":"ComponentPlayground"}};
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/ittai@1.0.4/node_modules/ittai/packages/react.js
// Webpack is great.
...
// EXTERNAL MODULE: ../../../builder/node_modules/.pnpm/css-loader@5.2.7_webpack@5.67.0/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!../../../builder/node_modules/.pnpm/sass-loader@10.2.1_sass@1.49.0+webpack@5.67.0/node_modules/sass-loader/dist/cjs.js!./components/HeaderOptions.scss
var HeaderOptions = __webpack_require__(178);
;// CONCATENATED MODULE: ./components/HeaderOptions.scss

            

var HeaderOptions_options = {"attributes":{"ittai":true,"plugin":"ComponentPlayground"}};

HeaderOptions_options.insert = "head";
HeaderOptions_options.singleton = false;

var HeaderOptions_update = injectStylesIntoStyleTag_default()(HeaderOptions/* default */.Z, HeaderOptions_options);



/* harmony default export */ const components_HeaderOptions = (HeaderOptions/* default.locals */.Z.locals || {});
;// CONCATENATED MODULE: ./components/HeaderOptions.tsx



//@ts-ignore

function HeaderOptions_extends() {
    HeaderOptions_extends = Object.assign || function(target) {
        for(var i = 1; i < arguments.length; i++){
            var source = arguments[i];
            for(var key in source){
                if (Object.prototype.hasOwnProperty.call(source, key)) {
    ...
    return HeaderOptions_extends.apply(this, arguments);
}
/* harmony default export */ const components_HeaderOptions_0 = (({ options  })=>{
    return(/*#__PURE__*/ react_namespaceObject.createElement(Flex, {
        className: components_HeaderOptions.wrapper
    }, options.map((option)=>{
        return(/*#__PURE__*/ react_namespaceObject.createElement("div", {
            className: components_HeaderOptions.pill,
            onClick: (e)=>ContextMenu.openContextMenu(e, ()=>{
                    return(/*#__PURE__*/ react_namespaceObject.createElement(components_ContextMenu, {
                        navId: option.name,
                        onClose: ContextMenu.closeContextMenu
                    }, option.options.map((r)=>/*#__PURE__*/ react_namespaceObject.createElement(components_ContextMenu.MenuRadioItem, HeaderOptions_extends({}, r))
                    )));
                })
        }, option.name));
    })));
...
function ExampleSettingsPage() {
    ...
    return(/*#__PURE__*/ react_namespaceObject.createElement(react_namespaceObject.Fragment, null, /*#__PURE__*/ react_namespaceObject.createElement(Category_Category, {
        title: "Buttons"
    }, /*#__PURE__*/ react_namespaceObject.createElement(ButtonDisplay, null)), /*#__PURE__*/ react_namespaceObject.createElement(Category_Category, {
        title: "Spinners"
    }, /*#__PURE__*/ react_namespaceObject.createElement(Flex, {
        justify: Flex.Justify.CENTER,
        align: Flex.Align.CENTER
    }, /*#__PURE__*/ react_namespaceObject.createElement(Spinner, null), /*#__PURE__*/ react_namespaceObject.createElement(Spinner, {
        type: Spinner.Type.CHASING_DOTS
    }), /*#__PURE__*/ react_namespaceObject.createElement(Spinner, {
        type: Spinner.Type.LOW_MOTION
    }), /*#__PURE__*/ react_namespaceObject.createElement(Spinner, {
        type: Spinner.Type.PULSING_ELLIPSIS
    }), /*#__PURE__*/ react_namespaceObject.createElement("div", {
        "data-note": "This DIV was added due to width issues. No need to worry"
    }, /*#__PURE__*/ react_namespaceObject.createElement(Spinner, {
        type: Spinner.Type.SPINNING_CIRCLE
    })))), /*#__PURE__*/ react_namespaceObject.createElement(Category_Category, {
        title: "Switches"
    }, /*#__PURE__*/ react_namespaceObject.createElement(SwitchItem, {
        value: switchValue,
        onChange: (val)=>{
        ...
        note: "I am gay"
    }, "Funni setting"), /*#__PURE__*/ react_namespaceObject.createElement(SwitchItem, {
        value: switchValue,
        onChange: (val)=>{
            set("funnySetting", val);
            setSwitchValue(val);
        ...
        disabled: true
    }, "No funni setting?"), /*#__PURE__*/ react_namespaceObject.createElement(Switch, {
        checked: switchValue,
        onChange: (val)=>{
            set("funnySetting", val);
            setSwitchValue(val);
...
const ButtonDisplay = ()=>{
    const [color, setColor] = (0,react_namespaceObject.useState)("BRAND");
    const [look, setLook] = (0,react_namespaceObject.useState)("FILLED");
    const [size, setSize] = (0,react_namespaceObject.useState)("MEDIUM");
    const options = [
        {
            name: "Colors",
    ...
    return(/*#__PURE__*/ react_namespaceObject.createElement(react_namespaceObject.Fragment, null, /*#__PURE__*/ react_namespaceObject.createElement(components_HeaderOptions_0, {
        options: options
    }), /*#__PURE__*/ react_namespaceObject.createElement(Flex, {
        justify: Flex.Justify.CENTER,
        align: Flex.Align.CENTER
    }, /*#__PURE__*/ react_namespaceObject.createElement(Button, {
        size: Button.Sizes[size],
        color: Button.Colors[color],
        look: Button.Looks[look]
    }, size === "ICON" ? /*#__PURE__*/ react_namespaceObject.createElement(DiscordIcon, {
        name: "At"
    }) : "Example Button"), /*#__PURE__*/ react_namespaceObject.createElement(Button, {
        disabled: true,
        size: Button.Sizes[size],
        color: Button.Colors[color],
        look: Button.Looks[look]
